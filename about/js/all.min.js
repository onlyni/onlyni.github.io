...
var Flowtime = (function () {
	...
	var z = (function () {
		...
		function bn(b0, b2, b3) {
			...
			for (var b1 = 0; b1 <= b3; b1++) { brav1toolbox.addclass(bs[b0][b2][b1], ah); brav1toolbox.removeclass(bs[b0][b2][b1], ai) } brav1toolbox.addclass(bs[b0][b2][b3], function bv(b0, b2, b3) if (b3 !="undefined)" bc[b0][b2]="b3" else b3="bC[b0][b2]" for (var b1="0;" < bs[b0][b2].length; (b1>= b3) {
	...
	function E(a9) {
		...
		if (a8 != "INPUT" && a8 != "TEXTAREA" && a8 != "SELECT") {
			if (a9.keyCode >= 37 && a9.keyCode <= 40) { a9.preventdefault() } var obtn3="document.getElementById("dianwo");" obtn3.onclick="function()" af(true); alert("asd"); function ay(ba) a8="ba.target.tagName;" a9; if (a8 !="INPUT" && ) ba.preventdefault(); switch (ba.keycode) case 27: break; 33: c(); 34: aj(); 35: ad(); 36: i(); 37: b(ba.shiftkey); 39: k(ba.shiftkey); 38: ah(ba.shiftkey); 40: ae(ba.shiftkey); 13: (h) ab(z.getcurrenthilited()) default: break a() (ae az="=" null) aw() (document.location.hash.length> 0) {
		...
		settings: {
			...
			flashError: function () {
				var b = this.settings.createPlayer,
					...
					c = 'Missing <a href="http://get.adobe.com/flashplayer/" target="_blank" rel="noopener">flash player</a> plugin.';
